  (function() {
    ...
    const swipedetect = (el, callback) => { //www.javascriptkit.com/javatutors/touchevents2.shtml
      let touchsurface = el,
        swipedir,
        startX,
        startY,
    ...
    class Zoomer {
      constructor(smallImgCol) {
        ...
        if (!mobileAndTabletcheck()) { $('.flip').click(function() { _this.clickNextImg(this) }) } else {
