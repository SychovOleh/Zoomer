(function() {
  mobileAndTabletcheck = () => { //https://stackoverflow.com/questions/11381673/detecting-a-mobile-browser
    let check = false;
  ...
  class Zoomer {
    constructor(smallImgCol) {
      ...
      if (!mobileAndTabletcheck) { $('.flip').click(function() { _this.clickNextImg(this) }) }
